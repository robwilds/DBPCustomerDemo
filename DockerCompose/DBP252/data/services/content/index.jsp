      ...
      <div class="index">
        ...
        <div class="index-list">
         ...
         <p></p>
          ...
          <p></p>
          <p><a href="/gs-api-explorer" target="_blank">Governace API explorer</a></p>
          <p></p>
          <p><a href="/activiti-app/api-explorer.html" target="_blank">Process Services API explorer</a></p>
          <p></p>
          <p><a href="" onclick="window.open('http://'+ window.location.hostname + ':9999')">Dozzle Container Monitoring</a></p>
          <p></p>
          <h2>Customizations</h2>
          <p><a href="" onclick="window.open('http://'+ window.location.hostname + ':5601')">Kibana Reporting</a></p>
          <p></p>
          <p><a href="" onclick="window.open('http://'+ window.location.hostname + ':8400')">LDAP config</a></p>
          <p></p>
          <p><a href="" onclick="window.open('http://'+ window.location.hostname + ':8800')">Email</a></p>
          <p></p>
          ...
          <iframe
            ...
            width="100%"
            height="800" http://localhost:8800
          ></iframe>
      <div class="push"></div>
    </div>
